...
class UpdateAuditScheduleRequest extends FormRequest
{
    ...
    {
        return [
            'audit_plan_id' => ['sometimes', 'required', 'exists:audit_plans,id'],
            'unit_kerja_id' => ['sometimes', 'required', 'exists:unit_kerjas,id'],
            'auditor_lead_id' => ['sometimes', 'required', 'exists:users,id'],
            ...
            'status' => ['sometimes', 'in:scheduled,ongoing,completed,cancelled,rescheduled'],
        ];
    }
