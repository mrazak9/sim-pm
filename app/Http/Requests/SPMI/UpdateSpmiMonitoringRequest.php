...
class UpdateSpmiMonitoringRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'tahun_akademik_id' => ['sometimes', 'required', 'exists:tahun_akademiks,id'],
            'title' => ['sometimes', 'required', 'string', 'max:255'],
            'description' => ['nullable', 'string'],
            'monitoring_date' => ['sometimes', 'required', 'date'],
            'monitoring_type' => ['sometimes', 'required', 'in:desk_evaluation,field_visit,interview,document_review,mixed'],
